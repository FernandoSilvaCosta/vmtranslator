...
### Parser
- ✅ has_more_commands
- ✅ advance e command_type
- ✅ arg1 e arg2 para push, pop e aritméticos
...
### parser.py
Lê o arquivo .vm, remove comentários de linha e inline, e tokeniza os comandos usando split por espaço. Classifica cada comando como C_ARITHMETIC, C_PUSH ou C_POP.

### code_writer.py
Gera o código Assembly Hack para cada comando VM. Usa labels únicos para operações relacionais (eq, gt, lt) e R13 como registrador auxiliar para operações pop em segmentos indexados.

### main.py
Ponto de entrada do tradutor. Recebe um arquivo .vm como argumento e gera o arquivo .asm correspondente no mesmo diretório.
